...
// --- Iconos para el Menú del Sidebar ---
...
export const PillIcon = ({ className }: { className?: string }) => (
  <svg className={className || "w-6 h-6"} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M12 15a3 3 0 100-6 3 3 0 000 6z" />
  </svg>
);
...
// --- Icono para el Botón del Navbar ---
